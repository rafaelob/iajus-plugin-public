...
| Busca híbrida com resultado visual (superfície de conector) | `buscar_juris_widget` | Mesma busca híbrida da `buscar_hibrida`, com o resultado formatado para o widget de conector (ex. ChatGPT). Em cliente comum, prefira `buscar_hibrida`. |
