...
- `jurimetria_*` (volume/relator/classe/orgao_julgador/resultado/lag/desfecho_cruzado) -
  números EXATOS; exigem recorte e trazem envelope de honestidade. Assinaturas + regras:
