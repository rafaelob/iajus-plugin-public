...
## Escolha da modalidade (8 tools de busca)
...
- Para "qual o entendimento atual", prefira precedentes qualificados (súmula /
  ...
  ou filtre `is_repercussao_geral`/`tema_numero` via `buscar_jurimetria`.
